...
if __name__ == '__main__':
    ...
    #     else:
    #         # inc = a
    #         current_distance += (cart - current_distance)

    # SECOND ATTEMPT
    # This may be much faster when I find the correct solution

    purchase = []
    current_distance = 0
    for x in carts:
        if current_distance < x:
            current_distance += x - current_distance + (a * wait + b * drink)
            purchase.append(carts.index(x))
